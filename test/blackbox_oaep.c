...
int main()
{
    ...
    mixencrypt_oaep(in1, out1, OAEP_BIMACRO_SIZE, key, iv1);
    ...
    for (i=0; i<OAEP_BIMACRO_SIZE; i+=OAEP_MINI_SIZE) {
        ...
        mixencrypt_oaep(in2, out2, OAEP_BIMACRO_SIZE*2, key, iv1);
        mixencrypt_oaep(in2, out3, OAEP_BIMACRO_SIZE,   key, iv2);
